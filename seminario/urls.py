...
urlpatterns = [
    ...
    path('ver_signos', ver_signos, name='ver_signos'),
    path('editar_signos', editar_signos, name='editar_signos'),
    path('borrar_signos/<int:pid>', borrar_signos, name='borrar_signos'),
